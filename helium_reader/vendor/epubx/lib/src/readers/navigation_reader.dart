      ...
      switch (navigationContentNodeAttribute.name.local.toLowerCase()) {
        ...
        case 'href':
          if (_tocFileEntryPath!.length < 2 ||
            ...
            result.Source = attributeValue.replaceAll("\\", "/");
          } else {
            // Keep hrefs in ZIP/EPUB POSIX form even when running on Windows.
            result.Source = path.posix
                .normalize(_tocFileEntryPath! + attributeValue)
                .replaceAll("\\", "/");
          }
